<div {{$attributes->merge(['class' => 'sticky top-0 z-50 navbar bg-gray-500 shadow-sm '])}} >
    <div class="navbar-start">
        ...
        <a class="btn btn-ghost text-xl">Blog | laravel  </a>
    </div>
    ...
    <a href="{{ route('profile', auth()->user()->id)}}">
        <img src="{{ auth()->user()->profile_image_url }}"
             alt="User_Avatar"
             class="mx-3 h-15 w-15 rounded-full object-cover">
    </a>
    @endauth

    <label class=" mx-3 swap swap-rotate">
